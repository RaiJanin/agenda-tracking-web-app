    ...
    <nav class="p-4">
        <div class="space-y-2">
            ...
            <div class="accordion-group">
                ...
                </div>    <a href="{{ route('concerns.all-concerns') }}" class="flex items-center space-x-3 p-2 rounded-lg {{ request()->routeIs('concerns.all-concerns') ? 'bg-blue-500 text-white' :'text-gray-700 hover:bg-gray-100' }} group relative ml-8 transition-all duration:300 ease-in-out">
