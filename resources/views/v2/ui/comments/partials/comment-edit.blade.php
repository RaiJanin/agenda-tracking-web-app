    ...
    <div class="p-4 col-span-3 sm:col-span-2 gap-3">
        <form class="flex flex-col gap-3"> 
            <div class="flex items-center justify-between">
                <h3 class="text-gray-600 text-md">Edit comment...</h3>
                <div class="flex flex-row gap-2">
                    <button type="button" class="close-edit-comment relative group flex items-center px-4 py-2 text-red-600 hover:text-red-500 transition-all duration-300">
                    ...
                    <button type="button" id="update-comment" class="relative group flex items-center px-4 py-2 text-blue-600 mr-5 hover:text-blue-500 transition-all duration-300">
